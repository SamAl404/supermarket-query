...
CREATE PROCEDURE AuditoriaInsertEmpleados
    @Carne NVARCHAR(30),
    @Nombre NVARCHAR(30),
    @Apellido VARCHAR(30)
AS
BEGIN
    ...
    INSERT INTO Empleados(Carne, Nombre, Apellido)
    VALUES (@Carne, @Nombre, @Apellido);

    SET @IdEmpleado = SCOPE_IDENTITY();

    INSERT INTO AuditoriaEmpleados (Accion, IdEmpleado)
    VALUES ('INSERT', @IdEmpleado);
END;

CREATE PROCEDURE AuditoriaUpdateEmpleados
    @IdEmpleado INT,
    @NuevoCarne NVARCHAR(30),
...
BEGIN
    ...
    INSERT INTO AuditoriaEmpleados (Accion, IdEmpleado)
    VALUES ('UPDATE', @IdEmpleado);
END;

CREATE PROCEDURE AuditoriaDeleteEmpleados
    @IdEmpleado INT
AS
BEGIN
...
CREATE PROCEDURE AuditoriaInsertProveedores
    @Nit INT,
    @Nombre NVARCHAR(30),
    @Telefono VARCHAR(30)
AS
BEGIN
    ...
    INSERT INTO Proveedores(Nit, Nombre, Telefono)
    VALUES (@Nit, @Nombre, @Telefono);

    SET @IdProveedores = SCOPE_IDENTITY();

    INSERT INTO AuditoriaProveedores (Accion, IdProveedores)
    VALUES ('INSERT', @IdProveedores);
END;

CREATE PROCEDURE AuditoriaUpdateProveedores
    @IdEmpleado INT,
    @NuevoNit INT,
    @NuevoNombre NVARCHAR(30),
...
BEGIN
    ...
    INSERT INTO AuditoriaProveedores (Accion, IdProveedores)
    VALUES ('UPDATE', @IdProveedores);
END;

CREATE PROCEDURE AuditoriaDeleteProveedores
    @IdEmpleado INT
AS
BEGIN
